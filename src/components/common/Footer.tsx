          ...
          <div className="flex flex-col items-center justify-center space-y-2 text-center">
            ...
            <div className="flex space-x-6">
              <a 
                ...
                style={{ color: 'rgb(var(--text-secondary))' }}
                onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) => (e.target as HTMLAnchorElement).style.color = 'rgb(var(--text-primary))'}
                onMouseLeave={(e: React.MouseEvent<HTMLAnchorElement>) => (e.target as HTMLAnchorElement).style.color = 'rgb(var(--text-secondary))'}
              >
                Privacy Policy
              </a>
              <a 
